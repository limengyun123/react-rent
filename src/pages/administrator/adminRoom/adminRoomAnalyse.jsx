...
class AdminRoomAnalyse extends Component{
    constructor(props) {
        super(props);
        ...
        return (
            <Row>
                <Col span={20} ref={this.heightRef}>
                    <section id="session-map" className="chart-section">
                        <h1>房屋分布地图</h1>
                        <ReactEcharts
                ...
                <Col span={4}>
                    <Anchor onClick={this.handleClick} className='anchor'>
                        <Link href="session-map" title="房屋分布地图" />
...
export default AdminRoomAnalyse
